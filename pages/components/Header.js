        ...
        <header>
            <div className={styles.header}>
                ...
                <div className={styles.header2}>
                    ...
                    <p className={styles.text}>Nos últimos 2 anos estudei e trabalhei com desenvolvimento Mobile e Web, criando aplicações em React Native, Api{`'`}s em Node.js e páginas Web utilizando Next.js e a plataforma Vercel. Equipe campeã do prêmio Case Secreto do BTG Open Finance.</p>
